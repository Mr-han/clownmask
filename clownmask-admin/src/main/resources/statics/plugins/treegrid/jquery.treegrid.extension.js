(function($) {
    "use strict";
    /**
     * 注意该JS经过了修改，父ID < 0 的Item,会单独显示一列。一种简单的实现多根节点的方法。
     */
    $.fn.bootstrapTreeTable = function(options, param) {
        ...
        target.getRootNodes = function(data) {
            ...
            $.each(data, function(index, item) {
                ...
                if (!item[options.parentCode] || (_root?(item[options.parentCode] == options.rootCodeValue):_defaultRootFlag) || item[options.parentCode] < 0){
                    result.push(item);
                }
